...
class PancakePriceQuery:
    ...
    def __init__(self):
        ...
        self.pancakeRouterAddress = self.web3.toChecksumAddress(config.PANCAKE_ROUTER_ADDRESS)
        self.pancakeContract = self.web3.eth.contract(address=self.pancakeRouterAddress,abi=tokenAbi(self.pancakeRouterAddress))
